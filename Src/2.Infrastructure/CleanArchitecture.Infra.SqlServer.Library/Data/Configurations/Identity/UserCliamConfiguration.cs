...
public class AppUserCliamConfiguration : IEntityTypeConfiguration<AppUserClaimEntity>
{
...
public class UserCliamConfiguration : IEntityTypeConfiguration<UserClaimEntity>
{
