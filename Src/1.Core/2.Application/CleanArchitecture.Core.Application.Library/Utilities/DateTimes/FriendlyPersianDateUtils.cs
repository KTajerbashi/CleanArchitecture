using CleanArchitecture.Core.Application.Library.Utilities.DateTimes;
...
public static class FriendlyPersianDateUtils
{
    ...
    public static string ToPersian(this DateTime date, string format = "yyyy/MM/dd hh:mm:ss")
    {
        if (date.ToString().Contains("000"))
            return "";
        return date.ToFa(format).ToEnglishNumber();
    }
    ...
    public static string ToPersian(this DayOfWeek dayOfWeek)
    {
