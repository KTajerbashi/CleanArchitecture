using CleanArchitecture.Core.Application.Library.Utilities.Attributes;
using System.Data;
...
public static class LinqExtensions
{
    ...
    public static T GetRowItem<T>(this DataRow dr)
    {
        Type genericType = typeof(T);
        T obj = Activator.CreateInstance<T>();
    ...
    public static List<T> MapDataTableToModel<T>(this DataTable dataTable) where T : new()
    {
        ...
        foreach (DataRow row in dataTable.Rows)
        {
            ...
            {
                // Get the ColumnName attribute applied to the property
                ...
                if (columnNameAttribute != null)
                {
                    ...
                    if (dataTable.Columns.Contains(columnName))
                    {
                        ...
                        // If the column value is not DBNull, assign it to the model's property
