...
namespace Persistance.Library.Migrations
{
    ...
    [Migration("20230713213823_Changes_Update_Database_Schema")]
    partial class Changes_Update_Database_Schema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Library.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1L,
                            CreateDate = new DateTime(2023, 7, 14, 1, 8, 23, 266, DateTimeKind.Local).AddTicks(3771),
                        ...
                        {
                            ID = 2L,
                            CreateDate = new DateTime(2023, 7, 14, 1, 8, 23, 266, DateTimeKind.Local).AddTicks(3816),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            IsDeleted = false,
                            Title = "Operator",
                        ...
                        {
                            ID = 3L,
                            CreateDate = new DateTime(2023, 7, 14, 1, 8, 23, 266, DateTimeKind.Local).AddTicks(3827),
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            IsDeleted = false,
                            Title = "Customer",
