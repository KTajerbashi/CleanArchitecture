...
{
    /// <inheritdoc />
    public partial class productentityhasbeenadded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    User = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: true),
                    ...
                    BatchKey = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuLinkChildID = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ContextTraceId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    CallSite = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    RecordHash = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignFile = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdateBy = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachmentObject = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreateByID = table.Column<long>(type: "bigint", nullable: false),
                    UpdateByID = table.Column<long>(type: "bigint", nullable: false),
                    DeleteByID = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FactorProducts_Products_ProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FactorProducts_ProductID",
                schema: "BUS",
                table: "FactorProducts",
                column: "ProductID");
